...
#max_epochs=30
max_epochs=8
modelName="spanner_",PRETRAINED,"_",dataname
idtest=dataname,'_',modelName
param_name='epoch',max_epochs,'_batchsize',batchSize,'_lr',LR,'_maxlen',MAXLEN

OUTPUT_DIR="output/train_logs/",dataname,"/",modelName
#mkdir -p $OUTPUT_DIR
subprocess.run(f"python -u trainer.py \
--dataname ",dataname," \
--data_dir ",DATA_DIR," \
...
--optimizer adamw >output/train_logs/",idtest,"_epoch",max_epochs,"_0606.txt &", shell=True)
