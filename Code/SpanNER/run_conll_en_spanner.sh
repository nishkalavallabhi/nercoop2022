...
OUTPUT_DIR="output/train_logs/multi/$dataname/${modelName}"
#mkdir -p $OUTPUT_DIR
echo "Calling trainer file..."
python trainer.py \
--dataname $dataname \
--data_dir $DATA_DIR \
...
--pretrained_checkpoint "output/train_logs/conll03_multi/spanner_bert-base-multilingual-uncased_spMLen_usePruneTrue_useSpLenTrue_useSpMorphTrue_SpWtTrue_value0.5_54959846/epoch=9.ckpt" \
--gpus=$gpus \
--precision=16 \
...
--optimizer "adamw" >output/train_logs/${idtest}_epoch${max_epochs}_0606.txt &
