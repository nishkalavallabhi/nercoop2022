...
class NERDA:
    ...
    def __init__(self, 
                 ...
                 device: str = None, 
                 tag_scheme: List[str] =  ['B-PER','I-PER',
                                            'B-PROD', 'I-PROD',
                                            'B-GRP', 'I-GRP',
                                            'B-CW', 'I-CW',
                                            'B-CORP', 'I-CORP',
                 ...
                 hyperparameters: dict = {'epochs' : 3,
                                          ...
                                          'fixed_seed': 42,
                                          'learning_rate': 0.00001},
                 tokenizer_parameters: dict = {'do_lower_case' : True, 'truncation' : True},
        ...
        self.transformer_model = AutoModel.from_pretrained(transformer)#, force_download=True)
        self.transformer_tokenizer = AutoTokenizer.from_pretrained(transformer, **tokenizer_parameters)#, force_download=True)
        self.transformer_config = AutoConfig.from_pretrained(transformer, force_download=True)  
    ...
    def train(self) -> str:
        ...
        """
        # print("Printing inside models.py:",self.dataset_training.get("sentences"))
    ...
    def evaluate_performance(self, dataset: dict, 
        ...
        tags_true = dataset.get('tags')
        new_tags_true = [] #create a new list of lists to address the 512 tokens issue.
        
        for i in range(0, len(tags_predicted)):
            templen = len(tags_predicted[i])
            new_tags_true.append(tags_true[i][:templen])
        """
        ...
        return myrep, tags_true, tags_predicted
